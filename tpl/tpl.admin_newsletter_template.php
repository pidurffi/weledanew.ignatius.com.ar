                            ...
                            <td style = "width:584px; height:156px;">
                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
		                             <tr>
                                        <td>
                                            <? // Logo de Weleda   ?>
                                            <img src="http://www.weleda.com.ar/imagenes/newsletter/TopNews_JUL15_izq.jpg" />
                                        </td>
                                        <td>
                                            <? // Imagen a la derecha del logo de Weleda.  ?>
                                            <img src="http://www.weleda.com.ar/imagenes/newsletter/TopNews_JUL15_der.jpg" />
                                        </td>
                                    </tr>
		                                </table>
                            </td>
                            ...
                            <td>
                                <table cellspacing="0" cellpadding="0" border="0">
                                    ...
                                    for ($i = 1; $i < 7; $i++) {
										...
										$fondo = ($i % 2) ? "fdo_violeta.jpg" : "fdo_violeta.jpg";
                                        ?>
                                        <tr>
...
// Si las dos noticias breves est�n vac�as, no sale el DIV.
                        if (!(empty($entity['breve_1_titulo']) AND empty($entity['breve_2_titulo']) )) {
                            ?>
                            <tr><td style = "width:584px; height:35px; padding-top:10px;"><img src = "http://www.weleda.com.ar/imagenes/newsletter/fdo_violeta.jpg"></img></td></tr>

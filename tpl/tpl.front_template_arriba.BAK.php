...
if (isset($actual) AND ($actual == "producto" OR $actual == "producto_suelto")) {
    ...
    ?>
            ...
            <link rel="image_src" href="http://www.weleda.com.ar/imagenes/productos/<?= $producto["foto_listado"] ?>" />
<?php
}
        ...
        <div id="contenedor" class="clearfix">
            ...
            <div id="encabezado<?php if ($inicio == "1") { ?>_inicio<?php }; ?>">
                ...
                <div id="encabezado_izq" style="position: relative;">
					<a href="./"></a>
					<? if($inicio != 1 AND isset($actual) AND ($actual=="productos" OR $actual=="familia" OR $actual=="linea" OR $actual=="producto" OR $actual=="producto_suelto" OR ($actual=="puntos_venta" AND $title != "Distribuidores") ))
					{
...
if ($inicio == 1 ) {
    /* Lo quito por ahora */
    ?>
                    <a href="http://www.facebook.com/weledaargentina" target="_BLANK" style="display:block;position:relative;left:612px;top:301px;width:112px;height:35px;"></a>
<? } ?>
